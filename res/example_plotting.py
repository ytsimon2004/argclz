...
class PlottingOptions:
    ...
    plt_config: str = argument('--plt', metavar='RC', default=None, help='name of matplotlib rc file')  # type: ignore[assignment]

    @contextlib.contextmanager
    def plot_figure(self, name: Path | None, *args, **kwargs) -> Iterator[Axes]:
